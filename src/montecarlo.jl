...
function mcdata!(stubs::StubSet, modules::MUonEStation; beamsize_x=1.0, beamsize_y=1.0)
    while true
        x0 = beamsize_x * randn(Float32)
        y0 = beamsize_y * randn(Float32)
...
"""
function generatebinmc(; nevents::Integer, mcfname::String, nmfname::String, ofname::String, cfnames=nothing, weight=1.0, beamsize_x=1.0, beamsize_y=1.0)
